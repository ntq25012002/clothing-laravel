...
@endsection
@section('content')
    <form class="form-inline ml-3" action="{{ route('admin.user.index') }}">
            ...
            <tbody>
                @foreach ($roles as $role)
                    <tr>
                        ...
                        <td>{{date('H:i:s',strtotime($role['updated_at']))}}</td>
                        <td>
                            <a href="{{ route('admin.role.edit-form', $role['id']) }}">
                                <i class="fas fa-pen-to-square"></i>
                        </td>
                        </a>
                        <td>
                            <a href="{{ route('admin.role.delete', $role['id']) }}" class="text-danger">
