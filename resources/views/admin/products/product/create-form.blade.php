            ...
            <form action="" method="post" enctype="multipart/form-data" id="form-add" class="form mb-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <input type="text" name="imageOlds" class="image-olds" value="" hidden>
                                ...
                                <div>
                                    ...
                                    <div>
                                        @foreach ($sizeAttrs as $item)
                                            <input type="checkbox" name="attrs[]" id="size{{$item->id}}"
                                ...
                                <div>
                                    ...
                                    <div>
                                        @foreach ($colorAttrs as $item)
                                            <input type="checkbox" name="attrs[]" id="color{{$item->id}}"
