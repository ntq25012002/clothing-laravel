            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="footer_widget">
                        <img src="{{asset('client/assets/img/logo.png')}}" class="img-footer small mb-2" alt="" />
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="footer_widget">
                        ...
                        <div class="address mt-3">
                            ...
                            <div class="scr_payment"><img src="{{asset('client/assets/img/card.png')}}" class="img-fluid" alt="" /></div>
                        </div>
                    </div>
                </div>
