                ...
                <div class="d-flex">
                    <div class="col-sm-6">
                        ...
                        <div class=" d-flex">
                            <div class="form-group col-sm-6 p-0">
                                ...
                                <input class="form-control" id="formFile" type="file" onchange="previewImage()"
                                    name="avatar" value="{{ old('avatar') }}">
                                <div>
                                    <img src="{{$user['avatar'] }}" id="img-preview" alt="" style="width:90px">
                                </div>
                                @error('avatar')
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" name="password_confirmation" class="form-control" type="password" value="{{old('password_confirmation')}}" required>
