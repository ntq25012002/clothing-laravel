...
@section('content')
    ...
    <form action="{{route('admin.product.delete-products')}}" id="myForm" class="form-delete" method="GET">
        ...
        <div class="col-md-12 d-flex justify-content-between">
            <button data-urlDelete="{{route('admin.product.delete-products')}}" type="submit" class="btn text-danger px-0 mb-5 submit btn-delete-select" disabled name="submit">Xóa mục đã chọn</button>
            <div>
                {{$products->links()}}
            </div>
        </div>
