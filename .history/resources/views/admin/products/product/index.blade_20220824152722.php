        ...
        <div class="card-body">
            ...
            <form class="form-inline ml-3" action="">
                <div class="form-group">
                    <select name="category" id="" class="form-control-sm form-control form-select mr-2">
                ...
                <div class="input-group input-group-sm">
                    <input class="form-control form-control-navbar" name="search_key" type="search" placeholder="Tìm..."
                        aria-label="Search" value="{{ request()->search_key }}">
                                ...
                                <td>
                                    @if(!empty($pr['promotional_price']))
                                        <p class="mb-0 text-success">
                                            {{number_format($pr['promotional_price'],0,',')}} đ
                                        </p>
                                        <del class="text-black-50">{{number_format($pr['price'],0,',')}} đ</del>
                                    @else
