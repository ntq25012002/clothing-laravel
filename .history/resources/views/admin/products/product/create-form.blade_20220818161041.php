                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        @foreach ($sizeAttrs as $item)
                                            <input type="checkbox" name="size_attrs[]" id="size{{$item->id}}"
                                                value="{{ old('color-attr') }}"> 
                                            <label for="size{{$item->id}}">{{$item->value}}</label>
                                        @endforeach
                                    </div>
                                    <div>
                                        @foreach ($colorAttrs as $item)
                                            <input type="checkbox" name="color_attrs[]" id="color{{$item->id}}"
                                            value="{{ old('color-attr') }}" class="mr-1"> 
                                            <label for="color{{$item->id}}">
                                                <i class="nav-icon fa-solid fa-shirt" style="color: {{ $item->value}}; font-size: 16px"></i>
                                            </label>
                                        @endforeach
                                    </div>
                                </div>
