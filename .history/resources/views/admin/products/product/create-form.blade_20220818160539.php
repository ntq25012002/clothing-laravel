                    ...
                    @endif
                        ...
                        <div class="d-flex">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="">Biến thể</label>
                                    @foreach ($sizeAttributes as $item)
                                        <input class="form-control" type="checkbox" name="size_attrs[]" id="size{{$item->id}}"
                                            value="{{ old('color-attr') }}"> <label for="size{{$item->id}}">{{$item->value}}</label>
                                    @endforeach
                                    @foreach ($colorAttributes as $item)
                                        <input class="form-control" type="checkbox" name="color_attrs[]" id="color{{$item->id}}"
                                        value="{{ old('color-attr') }}"> <label for="color{{$item->id}}"><span style="background-color:{{$item->value}}"></span></label>
                                    @endforeach
                                </div>
                            </div>
