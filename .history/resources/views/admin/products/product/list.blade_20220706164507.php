...
@section('content')
    ...
    <form action="{{route('admin.product.delete-products')}}" id="myForm" class="form-delete" method="POST">
        ...
        <div class="col-md-12 d-flex justify-content-between">
            <a data-urlDeleteSelect="{{route('admin.product.delete-products')}}" class=" text-danger px-0 mb-5 submit btn-delete-select" disabled name="submit">Xóa mục đã chọn</a>
            <div>
                {{$products->links()}}
            </div>
        </div>
