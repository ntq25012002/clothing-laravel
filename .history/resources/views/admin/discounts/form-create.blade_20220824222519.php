                ...
                <div class="d-flex">
                    <div class="col-sm-6">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" class="form-control form-control-input" name="time_strart">
                        </div>
                        <div>
                            <label for="">Ngày kết thúc</label>
                            <input type="datetime-local" class="form-control form-control-input" name="time_end">
                        </div>
                    </div>
