                ...
                <div class="d-flex">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" class="code_discount"
                                value="{{ old('name') }}">
    ...
    <script>
       $(document).ready(function() {
        ...
        $(document).on('click','.btn-submit',function(e){
            e.preventDefault();
            console.log($('.code_discount').val());
            if($('.code_discount').val() == null) {
                errName.html('Bạn chưa nhập mã khuyến mại')
            }else{
                errName.html('')
            }
            ...
            if($('#discount_type').val() == 0) {
                ...
                if(($('#price') && $('#price').val() == '') || ($('#percent') && $('#percent').val() == '')) {
                    ...
                    if($('#price').val() < 0) {
                        ...
                        errorMessage.html('Số phần trăm phải lớn hơn 0 và nhỏ hơn 100')
                    }else{
