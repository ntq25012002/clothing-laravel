                    ...
                    <tr>
                        ...
                        <td>
                            @if ($discount['status'] == 0)
                                <div class="btn btn-default">Đã dùng</div>
                            @elseif ($discount['status'] == 1)
                                <div class="btn btn-primary">Chưa dùng</div>
                            @endif
                        </td>
                        <td>{{ date('H:i:s d/m/Y ',(int)$discount->time_start) }}</td>
                        <td>{{ date('H:i:s d/m/Y ',(int)$discount->time_end) }}</td>
                        <td>
