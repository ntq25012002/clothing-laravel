...
@section('content-header-title')
    <h3>Chi tiết mã giảm giá</h3>
@endsection
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group p-0" >
                            ...
                            <select class="form-control form-select" name="type" id="discount_type">
                                <option value="0" {{$discount->type == 0 ? 'selected' : ''}}>Loại giảm giá </option>
                                <option value="1" {{$discount->type == 1 ? 'selected' : ''}}>Phần trăm</option>
                                <option value="2" {{$discount->type == 2 ? 'selected' : ''}}>Tiền</option>
                            </select>
                        ...
                        <div>
                            <div>
                                <div class="discount_value">
                                    ...
                                    <input class="form-control" type="number" name="value" id="{{$discount->type == 1 ? 'percent' : 'price'}}" 
                        ...
                        <div>
                            ...
                            <input type="datetime-local" class="form-control form-control-input" value="{{$discount->time_start}}" name="start">
                        </div>
                        <div>
                            <label for="">Ngày kết thúc</label>
                            <input type="datetime-local" class="form-control form-control-input" value="{{$discount->time_end}}" name="end">
                        </div>
                    </div>
