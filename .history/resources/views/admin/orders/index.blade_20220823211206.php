            ...
            <tbody>
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td>
                            @if ($order->status == 0)
                                <span class="background background-success">Đang chờ</span>
                            @elseif ($order->status == 1)
                                <span class="background background-success">Đang vận chuyển</span>
                            @elseif ($order->status == 2)
                                <span class="background background-success">Đã nhận hàng</span>
                            @endif
                        </td>
                        <td>{{$order->note }}</td>
