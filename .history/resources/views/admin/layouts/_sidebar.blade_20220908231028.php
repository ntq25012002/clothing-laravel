<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{asset('client/assets/img/logo-light.png')}}" alt=" Logo" class="brand-image "
           style="">
      <span class="brand-text font-weight-light">T </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset(Auth::user()->avatar)}}" class="img-circle elevation-2" alt="Avatar">
        </div>
        <div class="info">
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('admin.discount.create-form')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tạo mã giảm giá</p>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item">
              <a href="{{route('admin.customer.index')}}" class="nav-link">
                <i class="fa-regular fas fa-user-group nav-icon"></i>
               <p> Khách hàng </p>
            </a>
            </li>
