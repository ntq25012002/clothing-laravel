...
@section('css')
	...
	<link href="{{asset('client/assets/css/prd-detail.css')}}" rel="stylesheet">
@endsection
@section('content')
			<!-- ======================= Top Breadcrubms ======================== -->
			...
			<section class="middle">
				<div class="container">
					<form action="" id="formData" method="post" class="row">
						@csrf
						<input type="number" name="price" id="" value="{{$product->promotional_price > 0 ? $product->promotional_price : $product->price}}" hidden>
						<input type="text" name="prd-name" id="" value="{{$product->name}}" hidden>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="prd_details">
									...
									@foreach ($product->attributes as $itemAttr)
                                        @if ($itemAttr->name == 'color')
                                            <div class="form-check form-option form-check-inline mb-1">
                                                ...
                                                <label class="form-option-label small rounded-circle" for="color{{$itemAttr->id}}">
													<span class="form-option-color" style="background-color:{{$itemAttr->value}};display: block;
														position: absolute;
														top: 51%;
														left: 51%;
														width: 1.54rem;
								...
								<div class="prt_04 mb-4">
                                    <p class="d-flex align-items-center mb-1">Còn lại:<strong class="fs-sm text-dark ft-medium ml-1" id="available-quantity">{{$product->quantity > 0 ? $product->quantity : 'Hết hàng'}}</strong></p>
								...
								<div class="prt_05 mb-4">
									<div class="form-row mb-7">
										<div class="col-12 col-lg-auto">
											<!-- Quantity -->
                                            <input type="number" name="quantity" class="mb-2 custom-input" value="1" min="0" step="1" data-max_quantity="{{$product->quantity}}">
										</div>
										<div class="col-12 col-lg">
											<!-- Submit -->
											<button type="submit" data-url="{{route('add-to-cart',['id' => $product->id,'slug' => $product->slug])}}" data-prd_id="{{$product->id}}" class="btn btn-block custom-height bg-dark mb-2 add-to-cart" >
					...
					<div class="row">
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="d-flex align-items-center justify-content-start py-2">
								...
								<div class="d_capt">
									<h5 class="mb-0">Thanh toán an toàn</h5>
