                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <form class="mb-7 mb-md-0">
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-auto">
                                        <button class="btn btn-dark" id="btn-apply-discount" data-total="{{session()->get('total')}}" data-url="{{route('update-cart')}}" type="submit">Áp dụng</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            if(res.status == 200) {
                                ...
                                $('.total-after').html(res.total.formatNumber());
                                if(res.type == 1) {
