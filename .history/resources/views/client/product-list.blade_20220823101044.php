                    ...
                    <div class="search-sidebar sm-sidebar border">
                        <div class="search-sidebar-body">
                            ...
                            <form action="{{route('product-list')}} ">
                                ...
                                <div class="single_search_boxed">
                                    <div class="widget-boxed-header">
                                        <h4><a href="#size" data-toggle="collapse" class="" aria-expanded="false" role="button">Kích cỡ</a></h4>
                                    </div>
                                                    ...
                                                    <div class="text-left pb-0 pt-2">
                                                        @foreach ($sizeAttrs as $item)
                                                            <div class="form-check form-option form-check-inline mb-2">
                                                                <input class="form-check-input attrs" type="checkbox" {{ (request()->attr_sizes && in_array($item->id,request()->attr_sizes)) ?'checked':''}} value="{{$item->id}}" name="attr_sizes[]" id="size{{$item->id}}" hidden>
                                ...
                                <div class="single_search_boxed">
                                    <div class="widget-boxed-header">
                                        <h4><a href="#colors" data-toggle="collapse" class="" aria-expanded="false" role="button">Màu sắc</a></h4>
                                    </div>
                                                    ...
                                                    <div class="text-left">
                                                        @foreach ($colorAttrs as $item)
                                                            <div class="form-check form-option form-check-inline mb-1">
                                                                <input class="form-check-input attrs" {{ (request()->attr_colors && in_array($item->id,request()->attr_colors)) ?'checked':''}} type="checkbox" name="attr_colors[]" id="color{{$item->id}}" value="{{$item->id}}" hidden>
                                ...
                                <div class="single_search_boxed d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-dark my-2">Lọc sản phẩm</button>
                                </div>
                            </form>
                              <!-- Single Option Price-->
                            {{-- <div class="single_search_boxed">
                                    ...
                                    <div class="col-xl-9 col-lg-8 col-md-7 col-sm-12">
                                        <div class="filter_wraps d-flex align-items-center justify-content-end m-start">
                                            <div class="single_fitres mr-2 br-right">
                                                <form action="" method="GET" id="select-form-data">
                                                    <select name="filter_price" id="filter-price" class="custom-select simple">
                                                        <option value="default" selected="">Mặc định</option>
                                                        <option value="asc" {{!empty(request()->filter_price == 'asc'? 'selected' : '')}}>Lọc theo giá: Thấp đến cao</option>
                                                        <option value="desc" {{!empty(request()->filter_price == 'desc'? 'selected' : '')}}>Lọc theo giá: Cao xuống thấp</option>
                                                    </select>
                                                </form>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 text-center">
                                <a href="#" class="btn stretched-link borders m-auto">
                                    <i class="lni lni-reload mr-2"></i>Xem thêm
                                </a>
                            </div>
                        </div>
                    @endif
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $(document).on('change','#filter-price',function(e){
                document.getElementById('select-form-data').submit();
            })
