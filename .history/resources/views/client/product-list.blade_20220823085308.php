                                                    ...
                                                    <div class="text-left pb-0 pt-2">
                                                        @foreach ($sizeAttrs as $item)
                                                            <div class="form-check form-option form-check-inline mb-2">
                                                                <input class="form-check-input attrs" type="checkbox" {{ (request()->attrs && in_array($item->id,request()->attrs)) ?'checked':''}} value="{{$item->id}}" name="attr_sizes[]" id="size{{$item->id}}" hidden>
                                                    ...
                                                    <div class="text-left">
                                                        @foreach ($colorAttrs as $item)
                                                            <div class="form-check form-option form-check-inline mb-1">
                                                                <input class="form-check-input attrs" {{ (request()->attrs && in_array($item->id,request()->attrs)) ?'checked':''}} type="checkbox" name="attr_colors[]" id="color{{$item->id}}" value="{{$item->id}}" hidden>
