        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-lg-7 col-md-12">
                    ...
                    @elseif (!empty(session('myCart')) && count(session('myCart')) <= 0)
                        <h4 class="text-center">Giỏ hàng trống</h4>
                    @endif
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card mb-4 gray mfliud">
                        ...
                        <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                            ...
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Tổng tiền</span> <span class="ml-auto text-dark ft-medium total-after">{{number_format(session()->get('total'),'0',',','.')}} đ</span>
                            </li>
