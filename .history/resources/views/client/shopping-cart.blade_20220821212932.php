                                        ...
                                        <div class="col d-flex align-items-center justify-content-between">
                                            <div class="cart_single_caption pl-2">
                                                ...
                                                <div class="col-12 px-0 col-lg-auto">
                                                    <input type="number" name="cart_id{{$key}}" value="{{$key}}" id="">
                                                    <input type="number" name="quantity{{$key}}" class="mb-2 custom-input" value="{{$item['quantity']}}" min="1" step="1" >
                                                </div>
                                            </div>
                                            <div class="fls_last"><button class="close_slide gray remove_shopping_cart_item" data-url_delete="{{route('remove-cart-item',['id' => $key ])}}"><i class="ti-close"></i></button></div>
                                        </div>
                                    </div>
                                </li>
                            @endforeach 
