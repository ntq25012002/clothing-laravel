                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col d-flex align-items-center justify-content-between">
                                        <div class="cart_single_caption pl-2">
                                            ...
                                            <p class="mb-3 lh-1"><span class="text-dark">Màu: <span style="background-color:{{$item['color']}};margin-bottom:-4px; width:14px;height:14px; display:inline-block"></span></span></p>
