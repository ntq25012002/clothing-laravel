        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-lg-12 col-xl-12 col-md-12">
                                <div class="panel-group pay_opy980" id="payaccordion">
                                    ...
                                    <div class="panel panel-default border">
                                        <div class="panel-heading" id="pay">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" role="button" data-parent="#payaccordion" href="#cod" aria-expanded="true"  aria-controls="payPal" class="payments">
                                    ...
                                    <div class="panel panel-default border">
                                        <div class="panel-heading" id="pay">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" role="button" data-parent="#payaccordion" href="#payPal" aria-expanded="false"  aria-controls="payPal" class="payments">
                                    ...
                                    <div class="panel panel-default border">
                                        <div class="panel-heading" id="stripes">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" role="button" data-parent="#payaccordion" href="#stripePay" aria-expanded="false"  aria-controls="stripePay" class="payments">
                                    ...
                                    <div class="panel panel-default border">
                                        <div class="panel-heading" id="dabit">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" href="#payaccordion" data-target="#debitPay" aria-expanded="false"  aria-controls="debitPay" class="payments">
                ...
                <div class="col-12 col-lg-4 col-md-12">
                    ...
                    <a class="btn btn-block btn-dark mb-3 btn--submit" href="#" data-url="{{route('complete-order')}}">Xác nhận đặt hàng</a>
                </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','.btn--submit',function(e){
                ...
                if(paymentItem.length == payments.length) {
                    ...
                    let formCheckout = const formData = new FormData(form);
