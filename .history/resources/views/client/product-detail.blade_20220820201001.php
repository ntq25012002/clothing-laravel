						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="prd_details">
								...
								<div class="prt_04 mb-4">
                                    <p class="d-flex align-items-center mb-1">Còn lại:<strong class="fs-sm text-dark ft-medium ml-1" id="available-quantity">{{$product->quantity}}</strong></p>
								...
								<div class="prt_05 mb-4">
									<div class="form-row mb-7">
										<div class="col-12 col-lg-auto">
											<!-- Quantity -->
                                            <input type="number" name="quantity" class="mb-2 custom-input" value="1" min="0" step="1" max="{{$product->quantity}}">
										</div>
										<div class="col-12 col-lg">
											<!-- Submit -->
											<button type="submit" data-quantity={{$product->quantity}} data-url="{{route('add-to-cart',['id' => $product->id,'slug' => $product->slug])}}" data-prd_id="{{$product->id}}" class="btn btn-block custom-height bg-dark mb-2 add-to-cart" >
...
@section('scripts')
	<script src="{{asset('client/assets/js/add-to-cart.js')}}"></script>
