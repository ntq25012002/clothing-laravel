									...
									<div class="text-left">
										...
										<div class="elis_rty">
                                            @if ($product->promotional_price > 0)
                                                <span class="ft-medium text-muted line-through fs-md mr-2">{{number_format($product->price,'0',',','.')}}</span>
                                                <span class="ft-bold theme-cl fs-lg">{{number_format($product->promotional_price,'0',',','.')}}</span>
                                            @else
                                                <span class="ft-bold theme-cl fs-lg">{{number_format($product->price,'0',',','.')}}</span>
                                            @endif
                                        </div>
									</div>
								</div>
