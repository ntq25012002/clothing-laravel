                                        ...
                                        <div class="filter-card" id="shop-categories">
                                            @foreach ($categories as $item)
                                                ...
                                                <div class="single_filter_card">
                                                    @if ($item['parent_id'] == 0)
                                                        <h5>
                                                            <a href="#{{$item}}" data-toggle="collapse" class="collapsed" aria-expanded="false" role="button">
                                                                {{$item['name']}}<i class="accordion-indicator ti-angle-down"></i>
                                                            </a>
                                                        </h5>
                                                        {{-- {{dd($item->categoryChild()->count())}} --}}
                                                        @if($item->categoryChild()->count() > 0)
                                                            @foreach ($item->categoryChild() as $cate)
                                                                <div class="collapse" id="{{$item}}" data-parent="#shop-categories">
                                                                    <div class="card-body">
                                                                        <div class="inner_widget_link">
                                                                            <ul>
                                                ...
                                                <div class="text-left pb-0 pt-2">
                                                    @foreach ($sizeAttrs as $item)
                                                        <div class="form-check form-option form-check-inline mb-2">
                                                            <input class="form-check-input attrs" type="checkbox" value="{{$item->id}}" name="attrs[]" id="size{{$item->id}}" hidden>
