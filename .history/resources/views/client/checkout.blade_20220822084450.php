                                    ...
                                    <div class="panel panel-default border">
                                        <div class="panel-heading" id="cod">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" role="button" aria-expanded="true"  aria-controls="cod" class="">
                                                    Thanh toán khi nhận hàng<img src="{{asset('client/assets/img/paypal.html')}}" class="img-fluid" alt="">
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="cod" class="panel-collapse collapse show" aria-labelledby="cod" data-parent="#payaccordion">
