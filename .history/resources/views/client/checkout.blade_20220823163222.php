                    ...
                    <div class="col-12 col-lg-4 col-md-12">
                        <div class="d-block mb-3">
                            {{-- @if (count($totalItemPrd) > 0) --}}
                                <h5 class="mb-4">Sản phẩm ({{!empty($totalItemPrd) ?? '0'}})</h5>
                            {{-- @endif --}}
                        ...
                        <button type="submit" class="btn btn-block btn-dark mb-3 btn--submit" data-url_post="{{route('post-checkout')}}" href="{{route('complete-order')}}">Xác nhận đặt hàng</button>
                    </div>
