                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <form class="mb-7 mb-md-0">
                                ...
                                <div class="row form-row">
                                    <div class="col">
                                        <input class="form-control" name="discount" type="text" placeholder="Nhập mã giảm giá" value="{{isset(session()->get('codeDisc')['code-disc']) ? session()->get('codeDisc')['code-disc'] : ''}}">
                                        {{-- {{dd(session()->get('codeDisc')['code-disc'])}} --}}
                                ...
                                <span>Khuyến mãi</span> <span class="ml-auto text-dark ft-medium" id="discount">
                                    @if (!empty(session()->get('discount')))
                                        ...
                                        @elseif (session()->get('discount')['type'] == 2)
                                            {{number_format(session()->get('discount')['value'],'0',',','.')}} đ
                            ...
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                ...
                                <span class="ml-auto text-dark ft-medium total-after">
                                    @if (!empty(session()->get('discount')))
                                        ...
                                        @elseif (session()->get('discount')['type'] == 2)
                                            {{number_format(session()->get('total') - session()->get('discount')['value'] > 0 ?? 0,'0',',','.')}} đ
