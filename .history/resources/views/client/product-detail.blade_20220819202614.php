...
@section('content')
			...
			<section class="middle">
				<div class="container">
					<form action="{{route('add-to-cart')}}" method="POST" class="row">
						@csrf
								...
								<div class="prt_05 mb-4">
									<div class="form-row mb-7">
										...
										<div class="col-12 col-lg">
											<!-- Submit -->
											<button type="submit" data-url="{{route('add-to-cart',['id' => $product->id])}}" data-prd_id="{{$product->id}}" class="btn btn-block custom-height bg-dark mb-2 add-to-cart" >
