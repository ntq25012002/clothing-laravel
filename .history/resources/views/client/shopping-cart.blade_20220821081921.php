                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col d-flex align-items-center justify-content-between">
                                        <div class="cart_single_caption pl-2">
                                            ...
                                            <h4 class="fs-md ft-medium mb-3 lh-1">{{number_format($item['price'],'0',',','.')}}</h4>
                    ...
                    <div class="card mb-4 gray mfliud">
                        ...
                        <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Tổng</span> <span class="ml-auto text-dark ft-medium">{{number_format(session()->get('total'),'0',',','.')}}</span>
                            </li>
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Khuyến mãi</span> <span class="ml-auto text-dark ft-medium">$10.10</span>
                            </li>
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Tổng tiền</span> <span class="ml-auto text-dark ft-medium">{{number_format(session()->get('total'),'0',',','.')}}</span>
                            </li>
