        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
                    ...
                    <!-- Text -->
                    <p class="ft-regular fs-md mb-5">Mã đơn hàng <span class="text-body text-dark">{{session('code') ?? ''}}</span> của bạn đã hoàn tất. Chi tiết đơn hàng sẽ được gửi qua email của bạn.</p>
                    <!-- Button -->
                    <a class="btn btn-dark" href="#!">Tiếp tục mua hàng</a>
                </div>
            </div>
