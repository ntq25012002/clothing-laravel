								...
								<div class="prt_05 mb-4">
									<div class="form-row mb-7">
										...
										<div class="col-12 col-lg">
											...
											<!-- Submit -->
											<button type="submit" onclick="showSuccessToast()" data-url="{{route('add-to-cart',['id' => $product->id,'slug' => $product->slug])}}" data-prd_id="{{$product->id}}" class="btn btn-block custom-height bg-dark mb-2 add-to-cart" >
...
@section('scripts')
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			// 	e.preventDefault();
			// 	const url = $('.add-to-cart').data('url');
        ...
        function showSuccessToast() {
            toast({
                    title: 'Success',
                    message: 'Máy tính kết nối internet thành công !',
                    type: 'success',
                    duration: 4000,
                })
        }
        function showWarningToast() {
            toast({
                    title: 'Warning',
                    message: 'Máy tính kết nối internet không thành công !',
                    type: 'warning',
                    duration: 4000,
                })
        }
