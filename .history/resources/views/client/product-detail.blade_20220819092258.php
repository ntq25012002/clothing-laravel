								...
								<div class="prt_05 mb-4">
									<div class="form-row mb-7">
										<div class="col-12 col-lg-auto">
											<!-- Quantity -->
                                            <input type="number" name="quantity" class="mb-2 custom-input" style="min-width:70px;height: 52px;line-height: 1.5;padding: 0.875rem 1.5rem 0.875rem 1rem;border: 1px solid #e5e5e5;
                                            border-radius: 0;color: #868e96;">
