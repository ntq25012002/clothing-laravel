                                            ...
                                            <div class="single_fitres mr-2 br-right">
                                                <form action="" method="GET" id="select-form-data">
                                                    <select name="filter_price" id="filter-price" class="custom-select simple">
                                                        ...
                                                        <option value="asc" {{request()->filter_price == 'asc'? 'selected' : ''}}>Lọc theo giá: Thấp đến cao</option>
                                                        <option value="desc" {{request()->filter_price == 'desc'? 'selected' : ''}}>Lọc theo giá: Cao xuống thấp</option>
                                                    </select>
                                                </form>
