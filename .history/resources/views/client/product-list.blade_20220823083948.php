                    ...
                    <div class="search-sidebar sm-sidebar border">
                        <div class="search-sidebar-body">
                            ...
                            <form action="{{route('product-list')}} ">
                                ...
                                <div class="single_search_boxed">
                                    <div class="widget-boxed-header">
                                        <h4><a href="#size" data-toggle="collapse" class="collapsed" aria-expanded="true" role="button">Kích cỡ</a></h4>
                                    </div>
                                ...
                                <div class="single_search_boxed">
                                    <div class="widget-boxed-header">
                                        <h4><a href="#colors" data-toggle="collapse" class="collapsed" aria-expanded="true" role="button">Màu sắc</a></h4>
                                    </div>
                                                    ...
                                                    <div class="text-left">
                                                        @foreach ($colorAttrs as $item)
                                                            <div class="form-check form-option form-check-inline mb-1">
                                                                <input class="form-check-input attrs" {{in_array($item->id,request()->attrs)?'checked':''}} type="checkbox" name="attrs[]" id="color{{$item->id}}" value="{{$item->id}}" hidden>
