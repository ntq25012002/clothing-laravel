												...
												<tr>
												  ...
												  <td>
                                                    @foreach ($product->attributes as $itemAttr)
                                                        @if ($itemAttr->name == 'color')
                                                            <div class="form-check form-option form-check-inline mb-1">
                                                                <label class=""><span class="form-option-color " style="background-color:{{$itemAttr->value}}"></span></label>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                                  </td>
												...
												<tr>
												  ...
												  <td>
                                                    @foreach ($product->attributes as $itemAttr)
                                                        @if ($itemAttr->name == 'size')
                                                            <div class="form-check form-option form-check-inline mb-1">
                                                                <label class=""><span class="form-option-color ">{{$itemAttr->value}}</span></label>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                                  </td>
