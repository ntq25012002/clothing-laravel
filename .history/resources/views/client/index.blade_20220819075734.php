                    ...
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-body p-0">
                            <div class="shop_thumb position-relative">
                                ...
                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium">
                                        <i class="fas fa-eye mr-1"></i>Xem nhanh</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="text-left">
                                    @foreach ($item->attributes as $itemAttr)
                                        @if ($itemAttr->name == 'color')
                                            <div class="form-check form-option form-check-inline mb-1">
                                                <input class="form-check-input" type="radio" name="color{{$itemAttr->id}}" id="white2">
                                                <label class="form-option-label small rounded-circle" for="white2"><span class="form-option-color " style="background-color:{{$itemAttr->value}}"></span></label>
                                            </div>
                                        @endif
                                    @endforeach
                                </div>
