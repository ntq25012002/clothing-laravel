        ...
        <div id="main-wrapper">
			...
			<div>
				...
				<div>
					...
					<button onclick="showWarningToast()" class="btn btn--warning">
						Show toast warning
					</button>
					<button onclick="showInfoToast()" class="btn btn--info">
						Show toast info
					</button>
				</div>
			</div>
					...
					<div class="right-ch-sideBar">
						...
						<div class="cart_select_items py-2">
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{asset('client/assets/img/product/7.jpg')}}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
							...
							<div class="d-flex align-items-center justify-content-between px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{asset('client/assets/img/product/8.jpg')}}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
