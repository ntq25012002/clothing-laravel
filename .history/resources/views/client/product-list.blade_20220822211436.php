                    ...
                    <div class="search-sidebar sm-sidebar border">
                        <div class="search-sidebar-body">
                                                    ...
                                                    <ul class="no-ul-list">
                                                        @foreach ($categories as $item)
                                                            <li style="margin-left:{{ 20* $item['level']}}px">
                                                                <input id="cate{{$item['id']}}" class="checkbox-custom" value="{{$item['id']}}" name="categories[]" type="checkbox">
                                                ...
                                                <div class="text-left pb-0 pt-2">
                                                    @foreach ($sizeAttrs as $item)
                                                        <div class="form-check form-option form-check-inline mb-2">
                                                            <input class="form-check-input" type="checkbox" value="{{$item->id}}" name="attrs[]" id="size{{$item->id}}" hidden>
                                                ...
                                                <div class="text-left">
                                                    @foreach ($colorAttrs as $item)
                                                        <div class="form-check form-option form-check-inline mb-1">
                                                            <input class="form-check-input" type="checkbox" name="attrs[]" id="color{{$item->id}}" value="{{$item->id}}" hidden>
                            ...
                            <div class="single_search_boxed d-flex justify-content-end">
                                <div class="btn btn-dark my-2" id="btn_filter">Lọc sản phẩm</div>
                            </div>
                              <!-- Single Option Price-->
                            {{-- <div class="single_search_boxed">
                                <div class="widget-boxed-header">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#btn_filter',function (e) {
                e.preventDefault();
                let attrs = querySelectorAll("input[name='attrs']")
                let categories = querySelectorAll("input[name='categories']");

                console.log(attrs,categories);
            })
        })
    </script>
@endsection