            ...
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-lg-4 col-md-12">
                    <div class="d-block mb-3">
                        <h5 class="mb-4">Sản phẩm ({{count($cart)}})</h5>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col d-flex align-items-center">
                                            <div class="cart_single_caption pl-2">
                                                ...
                                                <p class="mb-3 lh-1"><span class="text-dark">Màu: <span style="display: inline-block;background-color:{{$item['color']}};width:14px;height:14px;margin-bottom:-3px"></span></span></p>
                    ...
                    <a class="btn btn-block btn-dark mb-3" href="{{route('complete-order')}}">Place Your Order</a>
                </div>
