                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <form class="mb-7 mb-md-0">
                                ...
                                <div class="row form-row">
                                    <div class="col">
                                        <input class="form-control" name="discount" type="text" placeholder="Nhập mã giảm giá*">
                                        <span class="message-error text-danger"></span>
                                        <span class="message-success text-success"></span>
                                    </div>
                                    <div class="col-auto">
                                        <button class="btn btn-dark" id="btn-apply-discount" data-url="{{route('update-cart')}}" type="submit">Áp dụng</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card mb-4 gray mfliud">
                        ...
                        <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                            ...
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Khuyến mãi</span> <span class="ml-auto text-dark ft-medium" id="discount">0</span>
                            </li>
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Tổng tiền</span> <span class="ml-auto text-dark ft-medium total-after">
                                    @if (!empty(session()->get('discount')))
                                        @if (session()->get('discount')['type'] == 1)
                                            {{number_format(session()->get('total')*session()->get('discount')['value']/100,'0',',','.')}} đ
                    ...
                    <a class="btn btn-block btn-dark mb-3" href="{{route('checkout')}}">Đặt hàng</a>
