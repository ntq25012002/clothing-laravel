...
Route::prefix('home')->group(function() {
    ...
    Route::get('/shopping-cart/delete/{id}/{idPrd}',[CartController::class,'removeCartItem'])->name('remove-cart-item');
...
Route::middleware('auth.admin')->name('admin.')->prefix('admin')->group(function () {
    ...
    Route::prefix('discount')->name('discount.')->group(function () {
        ...
        Route::get('create',[DiscountController::class, 'create'])->name('create-form');
        Route::post('create',[DiscountController::class, 'store'])->name('create');
        Route::get('edit/{id}',[DiscountController::class, 'show'])->name('edit-form');
        Route::post('edit/{id}',[DiscountController::class, 'update'])->name('edit');
        Route::get('delete/{id}',[DiscountController::class, 'destroy'])->name('delete');
        Route::post('delete-discounts',[DiscountController::class, 'deleteDiscounts'])->name('delete-discounts');
    });

    Route::prefix('order')->name('order.')->group(function () {
        Route::get('/',[OrderController::class,'index'])->name('index');
        Route::get('edit/{id}',[OrderController::class,'show'])->name('edit-form');
        Route::post('edit/{id}',[OrderController::class,'update'])->name('edit');
        Route::get('delete/{id}',[OrderController::class,'destroy'])->name('delete');
        Route::post('delete-orders',[OrderController::class,'deleteOrders'])->name('delete-orders');
    });

    Route::prefix('customer')->name('customer.')->group(function () {
        Route::get('/',[CustomerController::class,'index'])->name('index');
        Route::get('edit/{id}',[CustomerController::class,'show'])->name('edit-form');
        ...
        Route::post('delete-customers',[CustomerController::class,'deleteCustomers'])->name('delete-customers');
    });
