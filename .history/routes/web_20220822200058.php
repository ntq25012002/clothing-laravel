...
Route::prefix('home')->group(function() {
    ...
    Route::get('{slug?}/product',[ProductController::class,'productList'])->name('product-list');
    // Route::get('/{slug}/product',[ProductController::class,'productList'])->name('product-list-cate');
    ...
    Route::get('/product/{slug?}',[ProductController::class,'productDetail'])->name('prd-detail');
    Route::get('/product/{id?}/{slug?}',[CartController::class,'addToCart'])->name('add-to-cart');
