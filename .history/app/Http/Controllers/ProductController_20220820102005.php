...
class ProductController extends Controller
{
    protected $products;
    protected $attrs;
    public function __construct(Products $products, Attributes $attrs) {
    ...
    public function addToCart($id = null,$slug = null,Request $request) {
        ...
        if(isset($cart[$id.$color.$size]) && $cart[$id.$color.$size]['color'] == $color && $cart[$id.$color.$size]['size'] == $size) {
