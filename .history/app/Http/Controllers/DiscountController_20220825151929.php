...
class DiscountController extends Controller
{
    ...
    {
        dd($request->all(),$request->input('time-start'),date('Y-m-d H:i:s',(int)$request->input('time-start')),date('Y-m-d H:i:s',(int)$request->input('time-end')));
        // dd(date('Y-m-d H:i:s',$request->input('time-end')));
        $timeStart = date('Y-m-d H:i:s',$request->input('time-start'));
        // // dd($timeStart);
        $timeEnd = date('Y-m-d H:i:s',$request->input('time-end'));
        $data = [
            'name' => $request->name,
            'type' => $request->type,
            'value' => $request->value,
