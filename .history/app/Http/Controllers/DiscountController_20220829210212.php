...
class DiscountController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        $discounts = $this->discounts->loadList($filters);
    ...
    public function store(DiscountRequest $request)
    {
        ...
        $discount = $this->discounts->saveNew($data);
        if($discount) {
    ...
    {
        $discount = $this->discounts->loadOne($id);
    ...
    public function update(Request $request, $id){
        ...
        $discount = $this->discounts->saveUpdate($id,$data);
        if($discount) {
    ...
    public function deleteDiscounts(Request $request) {
        ...
        $this->discounts->removeMany($ids,$data);
