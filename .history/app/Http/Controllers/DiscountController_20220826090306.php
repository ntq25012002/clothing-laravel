...
class DiscountController extends Controller
{
    ...
    public function update(Request $request, $id){
        ...
        $discount = $this->discounts->update($data);
        if($discount) {
            return redirect()->route('admin.discount.edit-form')->with('msg','Cập nhật thông tin thành công!');
        }else{
            return redirect()->route('admin.discount.edit-form')->with('err','Lỗi cập nhật!');
