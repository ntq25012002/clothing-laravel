...
class ProductController extends Controller
{
    ...
    public function index($category_id = null){
        ...
        if(!empty($category_id)) {
            $products = $this->products->select('*')->selectRaw('MATCH(category_track) AGAINST(? IN NATURAL LANGUAGE MODE)', [$category_id])->whereRaw('MATCH(category_track) AGAINST(? IN NATURAL LANGUAGE MODE)', [$category_id])->get();
